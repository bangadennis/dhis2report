...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#saveReportDefinitionCode").click(function () {
            $.post("${pageContext.request.contextPath}/module/dhisreport/editReportCode.form", {
                reportCode: document.getElementById("reportCode").value,
                reportId: document.getElementById("reportDefinitionId").value
            });
            setTimeout(function () {
